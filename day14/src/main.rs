...
fn step_1(input: &str) {
    ...
    'sand: loop { // for all failing sand
        ...
        'falling: loop {
            ...
            println!("fell off at ({x},{y}) dropped {}", sand_grains-1);
            break 'sand;
        }
    }
}
...
fn step_2(input: &str) {
    ...
    let mut cave: Vec<Vec<Voxel>> = Vec::new();
    for _y in 0..=max_y {
        cave.push(vec![Voxel::Space;max_x as usize+200]);
    }
    cave.push(vec![Voxel::Space;max_x as usize+200]);
    cave.push(vec![Voxel::Rock;max_x as usize+200]);
    ...
    'sand: loop { // for all failing sand
        ...
        if x == 500 && y == 0 && 
        cave[1][500] == Voxel::Sand &&
        cave[1][499] == Voxel::Sand &&
        cave[1][501] == Voxel::Sand {
